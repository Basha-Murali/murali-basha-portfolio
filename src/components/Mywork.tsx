...
//   {
//     title: "Springboard",
//     category: "TRC Companies",
//     description:
//       "A web platform for managing and cleansing spatial and non-spatial datasets using QA/QC analytics. Developed rule-based workflows with OpenRules, dynamic dashboards in React.js, and Node.js REST APIs for data validation.",
...
//     category: "TRC Companies",
//     description:
//       "Developed RESTful APIs using Node.js and MongoDB for LNG infrastructure workflows. Improved API response times by 20% and executed database migration scripts for consistent backend data synchronization.",
...
//     category: "TRC Companies",
//     description:
//       "Built an administration portal for ticket management with multi-tenant user roles. Developed scalable REST APIs, fixed critical bugs improving stability by 30%, and integrated QA automation workflows.",
//     tech: ["Node.js", "React.js", "REST API"],
//   },
//   // Personal Project
//   {
//     title: "DevTinder",
...
//     description:
//       "A social matching application built using the MERN stack. Includes JWT-based authentication, profile management, friend requests, and chat features with secure backend APIs.",
...
//           className="bg-gray-900 border border-gray-800 rounded-lg p-6 text-left shadow-md hover:shadow-accent/40 transition"
//         >
